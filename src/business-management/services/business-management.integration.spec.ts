...
describe('BusinessManagementService Integration Tests', () => {
  ...
  beforeAll(async () => {
    ...
    businessManagementService = moduleRef.get<BusinessManagementService>(
      BusinessManagementService,
    );
    businessService = moduleRef.get<BusinessService>(BusinessService);
    businessOpeningHoursService = moduleRef.get<BusinessOpeningHoursService>(
      BusinessOpeningHoursService,
    );
    serviceOfferingService = moduleRef.get<ServiceOfferingService>(
    ...
    serviceOfferingRepository = moduleRef.get<Repository<ServiceOffering>>(
      getRepositoryToken(ServiceOffering),
    );
    businessOpeningHoursRepository = moduleRef.get<
      Repository<BusinessOpeningHours>
    >(getRepositoryToken(BusinessOpeningHours));
    await setupTestData();
  });
  ...
  describe('Business Creation and Management', () => {
    it('should allow business owner to create a business', async () => {
      ...
      expect(createdBusiness.location.address).toBe(createBusinessDto.address);
    ...
    it('should allow business owner to update business details', async () => {
      ...
      const updatedBusiness =
        await businessManagementService.updateBusinessDetails(
          businessOwner.id,
          testBusiness.id,
          updateDto,
        );
      ...
      expect(updatedBusiness.contact.website).toBe(updateDto.website);
    });
    ...
    it('should allow business owner to update opening hours', async () => {
      ...
      const updatedHours = await businessOpeningHoursService.findByBusinessId(
        testBusiness.id,
      );
  ...
  describe('Service Offerings Management', () => {
    ...
    it('should allow business owner to add service offerings', async () => {
      ...
      serviceOfferings =
        await businessManagementService.addBusinessServiceOfferings(
          businessOwner.id,
          testBusiness.id,
