...
describe('BookingDtoService', () => {
  ...
  describe('mapBookingToDto', () => {
    ...
    beforeEach(() => {
      (BookingMapper.toResponseDto as jest.Mock).mockReturnValue({
        ...dtoWithSensitive,
      });
    });
  ...
  describe('createPaginatedResponse', () => {
    it('should create paginated response correctly', () => {
      ...
      jest.spyOn(service, 'mapBookingToDto').mockImplementation(
        (booking: Booking) =>
          ({
            id: booking.id,
      ...
      const result = service.createPaginatedResponse(
        bookings,
        total,
        options,
        context,
