...
describe('BookingCreationService', () => {
    ...
    beforeEach(async () => {
        ...
        mockBookingRepo.manager.connection.createQueryRunner.mockReturnValue(mockQueryRunner);
    });
    ...
    it('should rollback and throw error if something fails', async () => {
        ...
        await expect(service.createBookingWithTransaction(dto)).rejects.toThrow('Something went wrong');
